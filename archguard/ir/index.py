...
from archguard.ir.types import ArchitectureIR, CanonicalId, DepType, IREdge, IRNode, SymbolKind
...
def build_index(ir: ArchitectureIR) -> IRIndex:
    ...
    frozen_edges_by_type: Dict[DepType, tuple[IREdge, ...]] = {
        k: tuple(v) for k, v in edges_by_type.items()
    }
