...
from archguard.ir.types import DepType, IREdge, IRNode, SymbolKind
...
# Convenience generators (useful in evaluators)

def iter_dependency_edges(edges: Iterable[IREdge]) -> Iterator[IREdge]:
    """
    Commonly, rules want dependency edges only.
    """
    for e in edges:
        yield e  # all edges are dependencies in IR; keep for future filtering
