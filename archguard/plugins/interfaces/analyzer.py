# archguard/plugins/interfaces.py
...
from archguard.ir.types import ArchitectureIR, Language

# Analyze target (optional but practical)
...
class Analyzer(Protocol):
    ...
    def plugin_id(self) -> str:
        ...
        Example: "archguard-python", "archguard-java".
        """
        raise NotImplementedError()
