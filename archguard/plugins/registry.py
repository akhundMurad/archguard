...
from archguard.ir.types import Language
from archguard.plugins.interfaces import Analyzer


ENTRYPOINT_GROUP: Final[str] = "archguard.analyzers"
...
class LoadedAnalyzer:
    ...
    """
    analyzer: Analyzer
    source: str  # e.g. "archguard_python.plugin:PythonAnalyzer"
...
class AnalyzerRegistry:
    ...
    def load_entrypoints(self) -> None:
        """
        Discover analyzers registered under entrypoint group 'archguard.analyzers'.
